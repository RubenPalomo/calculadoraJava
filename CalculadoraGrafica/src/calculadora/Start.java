...
public class Start {
	...
	private void initialize() {
		...
		frmCalculadora.setIconImage(Toolkit.getDefaultToolkit().getImage("C:\\Users\\elrub\\Downloads\\calculator-icon_34473.png"));
		frmCalculadora.setTitle("Rub\u00E9n P.");
		frmCalculadora.setBounds(100, 100, 241, 331);
		...
		frmCalculadora.getContentPane().add(screen);
		...
		// BOTÓN DE REINICIO DE LA CALCULADORA (C)
		...
		frmCalculadora.getContentPane().add(buttonC);
		...
		frmCalculadora.getContentPane().add(button0);
		...
		frmCalculadora.getContentPane().add(button1);
		...
		frmCalculadora.getContentPane().add(button2);
		...
		frmCalculadora.getContentPane().add(button3);
		...
		frmCalculadora.getContentPane().add(button4);
		...
		frmCalculadora.getContentPane().add(button5);
		...
		frmCalculadora.getContentPane().add(button6);
		...
		frmCalculadora.getContentPane().add(button7);
		...
		frmCalculadora.getContentPane().add(button8);
		...
		frmCalculadora.getContentPane().add(button9);
		
		// BOTONES PARA LAS OPERACIONES
		
		// Botón igual, para resolver operaciones
		...
		frmCalculadora.getContentPane().add(buttonEqual);
		
		// Botón par, para saber si un número es par en cualquier momento
		...
		frmCalculadora.getContentPane().add(buttonPar);
		
		// Botón suma, para realizar sumas de 2 números
		...
		frmCalculadora.getContentPane().add(buttonPlus);
		
		// Botón resta, para realizar restas de 2 números
		...
		frmCalculadora.getContentPane().add(buttonMinus);
		
		// Botón multiplicación, para hallar el producto de 2 números
		...
		frmCalculadora.getContentPane().add(buttonMultiplied);
		
		// Botón división, para realizar divisiones de 2 números
		...
		frmCalculadora.getContentPane().add(buttonDivided);
	}
}